        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingSession_Address_BillingAddressId",
                        column: x => x.BillingAddressId,
                        principalTable: "Address",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingSession_Payment_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "Payment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingSession_Address_ShippingAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItem_ShoppingSession_CartId",
                        column: x => x.CartId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingSession_BillingAddressId",
                table: "ShoppingSession",
                column: "BillingAddressId");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingSession_PaymentId",
                table: "ShoppingSession",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingSession_ShippingAddressId",
                table: "ShoppingSession",
